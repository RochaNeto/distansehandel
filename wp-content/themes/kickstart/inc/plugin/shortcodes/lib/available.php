		...
		$shortcodes = array(
			...
			'content-shortcodes-open' => array(
				...
				'testimonials_slider' => array(
					...
					'content' => __( '[testimonial author=&quot;Author Name&quot;] Quote text [/testimonial][testimonial author=&quot;Author Name&quot;] Quote text 2[/testimonial_slider]', 'mnky-admin' ),
				...
				'tweets' => array(
					...
					'atts' => array(
						'username' => array(
							'values' => array( ),
							'default' => 'twitter',
							'desc' => __( 'Twitter username', 'mnky-admin' )
						),
						'list' => array(
							'values' => array( ),
							'default' => '',
							'desc' => __( 'Tweets from the list', 'mnky-admin' )
						),
						'query' => array(
							'values' => array( ),
							'default' => '',
							'desc' => __( 'Tweets from the query', 'mnky-admin' )
						),
						'limit' => array(
							'values' => array(
								'1',
							...
							'default' => '3',
							'desc' => __( 'Number of tweets to show', 'mnky-admin' )
						)
					),
					'usage' => '[tweets username="gn_themes" limit="3" style="1" format="teaser"]',
					'desc' => __( 'Get newest tweets', 'mnky-admin' )
				),
