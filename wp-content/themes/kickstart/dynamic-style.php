...
?>
		...
		#primary-main-menu > li.current-menu-item a:after, #primary-main-menu > li.current-menu-ancestor a:after, #primary-main-menu > li.current_page_parent > a:after, #header-search-wrapper:before {border-bottom-color:<?php echo $site_gc; ?>;} 
