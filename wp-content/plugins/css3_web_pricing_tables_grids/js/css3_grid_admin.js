			...
			if($(event.target).attr("id")=="rows")
			{
				...
				if(rows>previousRows)
				{
					...
					for(var j=0; j<columns; j++)
					{
						...
						if(j==0)
							rowHtml += "<div class='css3_grid_arrows_row'><a href='#' class='css3_grid_sort_up' title='up'></a><a href='#' class='css3_grid_sort_down' title='down'></a></div><div class='css3_grid_row_config'><input class='css3_grid_short' type='text' name='heights[]' value='' /><label>height (optional in px)</label><br class='css3_responsive_height'" + (parseInt($("#responsive").val())==1 ? " style='display: inline;'" : "") + " /><input class='css3_grid_short css3_responsive_height'" + (parseInt($("#responsive").val())==1 ? " style='display: inline;'" : "") + " type='text' name='responsiveHeights[]' value='' /><label class='css3_responsive_height'" + (parseInt($("#responsive").val())==1 ? " style='display: inline;'" : "") + ">responsive height (optional)</label><br /><input class='css3_grid_short' type='text' name='paddingsTop[]' value='' /><label>padding top (optional in px)</label><input class='css3_grid_short' type='text' name='paddingsBottom[]' value='' /><label>padding bottom (optional in px)</label></div>";
						else
