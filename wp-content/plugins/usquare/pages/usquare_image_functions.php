...
abstract class usquare_image_class {
	...
	abstract function save( $suffix = null, $dest_path = null, $jpeg_quality = 90 );
}


class fol_gd extends usquare_image_class {
	function __destruct () {
	...
	function save( $suffix = '', $dest_path = '', $jpeg_quality = 90 ) {
...
class fol_imagick extends usquare_image_class {
	function __destruct () {
...
/*
echo "GD: ".usquare_image_class::test_gd()."<br />";
echo "Imagick: ".usquare_image_class::test_imagick()."<br />";
exit;

//$img = new fol_gd('C:\Users\Predrag Damnjanovic\Dropbox\wordpress\wp-content\uploads\2013\01\3smbas.jpg');


$img = usquare_image_class::create_object('C:\Users\Predrag Damnjanovic\Dropbox\wordpress\wp-content\uploads\2013\01\frog_horse_up.gif', 'gd');
